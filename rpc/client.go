...
// FetcherSubscribe registers a subscripion under the "fetcher" namespace.
func (c *Client) FetcherSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "fetcher", channel, args...)
}

// MarketcapSubscribe registers a subscripion under the "marketcap" namespace.
func (c *Client) MarketcapSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "marketcap", channel, args...)
}
