...
type jsonNotificationWithMethodName struct {
	Version string           `json:"jsonrpc"`
	Method  string           `json:"method"`
	Tag     string           `json:"tag"`
	Params  jsonSubscription `json:"params"`
...
func (c *jsonCodec) CreateNotificationWithMethodName(subid, namespace, method string, event interface{}) interface{} {
	return &jsonNotificationWithMethodName{Version: jsonrpcVersion, Method: namespace +notificationMethodSuffix,
		Tag:method,
		Params: jsonSubscription{Subscription: subid, Result: event}}
}
